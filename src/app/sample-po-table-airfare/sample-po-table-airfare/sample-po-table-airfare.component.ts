...
@Component({
  selector: 'app-sample-po-table-airfare',
  templateUrl: './sample-po-table-airfare.component.html',
  styleUrls: ['./sample-po-table-airfare.component.css'],
...
export class SamplePoTableAirfareComponent implements AfterViewInit {
  ...
  discount(item: string | any| { [key: string]: any; }) {
  ...
  private validateDiscount(item: string|any) {
